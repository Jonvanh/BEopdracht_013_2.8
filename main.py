...
def force(mass, body='earth'):
    ...
    if not Isfloat:
        ...
        bodygravity = body_dictionary.get(body)
        return mass * bodygravity
...
print(force(0.1, "earth"))          # 0.9800000000000001
...
print(pull(800.0, 1500.0, 3.0))                                     # 0,000009 
print(pull(0.1, 5972000000000000000000000000.0, 6371000000.0))      # 0.98
